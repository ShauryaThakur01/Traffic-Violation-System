• Developed a Traffic Violation which is able to check if a vehicle is violating any traffic light, not wearing helmet, triple riding on bike and detects number plate which is stored in a database.
